...
# The energy you need to reach an enemy is equal to the distance you receive. Each time you reach an
# enemy, you win a battle, and your energy is reduced. Otherwise, if you don't have enough energy to
# reach an enemy, end the program and print:
